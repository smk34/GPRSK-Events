...
<html>
    ...
    <body>
        ...
        <div class="content">
            <div class="container" >
                <h1 style="text-align:center;margin-top:2%;margin-bottom:2%"> Location Form</h1><!--form title-->
                <?php
                ...
                <form action="createLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="managerFName" class="col-md-3 control-label">Manager First Name</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="managerLName" class="col-md-3 control-label">Manager Last Name</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="managerEmail" class="col-md-3 control-label">Manager Email</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="managerNumber" class="col-md-3 control-label">Manager Number</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="locationMaxCap" class="col-md-3 control-label">Max Capacity</label>
                        <div class="col-md-6">
                ...
                <!--codes below has no connection with the database.-->
					...
					<div class="col-ms-12 text-center" style="margin-top:2%">
                <button type="submit" name="createLocation" class="btn btn-primary" style="text-align:center">Create Location <span class="glyphicon glyphicon-send"></span></button>
                
                <a class="btn btn-primary" href="viewLocations.php">Back</a></div>
