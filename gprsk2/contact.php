...
<html>
    ...
    <body>
        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts" style="margin-top:8%">
                    <h3><span class="glyphicon glyphicon-user"></span> GPRSK EVENT MANEGEMENT SYSTEM</h3>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: gprsk2020@gmail.com<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: www.facebook.com/gprsk<br>
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 0123456789
                    </p>
                </div>
