...
<html>
    ...
    margin-top: 6%; margin-bottom: 7%;"> Event Form</h1><!--form title-->
                <?php
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    <div class="form-group">
						<br>
                        <label for="Title" class="col-md-3 control-label">Title</label><!--event title-->
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="Description" class="col-md-3 control-label">Description</label><!--event description-->
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="StartDate" class="col-md-3 control-label">Start Date</label><!--start date-->
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="EndDate" class="col-md-3 control-label">End Date</label><!--end date-->
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="Cost" class="col-md-3 control-label">Cost</label><!--cost-->
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="LocID" class="col-md-3 control-label">Location ID</label><!--location id-->
                        <div class="col-md-6">
                            <select name="LocID"
                                        id="LocID"
                                        class="form-control"
